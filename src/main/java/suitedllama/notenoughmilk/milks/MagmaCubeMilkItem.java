...
public class MagmaCubeMilkItem extends Item {

   public MagmaCubeMilkItem(Settings settings) {
      super(settings);
   }
   ...
   public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
      ...
      if (!world.isClient) {
           ...
           user.addStatusEffect(new StatusEffectInstance(StatusEffects.JUMP_BOOST, 3000, 0));
