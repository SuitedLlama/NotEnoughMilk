...
public class RabbitMilkItem extends Item {

   public RabbitMilkItem(Settings settings) {
      super(settings);
   }
   ...
   public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
      ...
      if (!world.isClient) {
           ...
           user.addStatusEffect(new StatusEffectInstance(StatusEffects.LUCK, 6000, 0));
