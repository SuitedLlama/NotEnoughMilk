...
public class HoglinMilkItem extends Item {

   public HoglinMilkItem(Settings settings) {
      super(settings);
   }
   ...
   public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
      ...
      if (!world.isClient) {
        if (user.world.getDimension().isUltrawarm()){
           ...
           user.addStatusEffect(new StatusEffectInstance(StatusEffects.SATURATION, 6000, 0));
        }
      }
